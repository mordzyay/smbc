...
function m:draw()
	...
	if self.state == "dead" then
		drawSprite(sprites.koopa[3], math.floor(self.x), math.floor(self.y+1), false, false)
	end
	if self.state == "alive" then
		if self.shelled then
			drawSprite(sprites.koopa[3], math.floor(self.x), math.floor(self.y+3), false, true)
		else
			drawSprite(self.frame > 12 and sprites.koopa[2] or sprites.koopa[1], math.floor(self.x), math.floor(self.y+1), self.xs < 0 and true or false, false)
		end
	end
